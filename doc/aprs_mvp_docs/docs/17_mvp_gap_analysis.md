...
- KISS-over-BLE is implemented in firmware
...
- SGTL5000 clock validation, gain tuning, and real RF/audio validation remain gating work
...
1. `05_ble_gatt_spec.md`, `16_kiss_over_ble_spec.md`, and code must be brought into alignment during implementation.
...
## 4. App and tooling gaps (updated 2026-03-16)
...
## 5. Recommended implementation order (updated 2026-03-16)
...
- Run first hardware bring-up with BLE security, SA818, SGTL5000 MCLK, and PTT safety as the priority sequence.
