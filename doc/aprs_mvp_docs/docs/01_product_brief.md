...
## One‑sentence
A pocket APRS tracker + message TNC for 2m that pairs to a phone over BLE, eliminating audio cables and manual level tuning.
...
- BLE-first for phone connectivity
